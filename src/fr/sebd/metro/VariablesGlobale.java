...
public interface VariablesGlobale {
    ...
    public static final Map<String, String[]> LIGNES_METRO = new HashMap<>() {
...

        {
            ...
            put("B", new String[]{"B1", "B2", "B3", "B4", "JAVA", "B5", "B6", "B7", "PHP","B8", "B9", "B10", "B11", "B12", "B13", "B14", "B15", "B16", "RUBY", "B17", "B18", "B19"});
    ...
    public static final Map<String, List<String>> NOEUDS = new HashMap<>() {
        {
            put( "JAVA", Arrays.asList("PHP","JAVASCRIPT"));
            put( "JAVASCRIPT", Arrays.asList("JAVA","HTML"));
            put( "PHP", Arrays.asList("JAVA","HTML","RUBY"));
            put( "HTML", Arrays.asList("JAVASCRIPT","RUBY","PHP"));
            put( "RUBY", Arrays.asList("HTML","PYTHON"));
            put( "PYTHON", Arrays.asList("RUBY"));
        }};
